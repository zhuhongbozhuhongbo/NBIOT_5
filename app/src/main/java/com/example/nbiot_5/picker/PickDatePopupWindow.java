package com.example.nbiot_5.picker;
...
public class PickDatePopupWindow extends PopupWindow implements PickerView.onSelectListener {
    ...
    protected boolean initView(Integer year, Integer month, Integer day) {
        ...
        View view = mInflater.inflate(R.layout.date_pick, null, true);
        ...
        int thisYear = new Date().getYear() + 2000;
        ...
        if (year >= 2000 && year <= new Date().getYear() + 2000) {
            mYearPickerView.setSelected(year - 2000);
        }
